...
from hypunet.experiment_planning.experiment_planner_baseline_3DUNet_v21 import (
...
class ExperimentPlanner3D_v21_Pretrained(ExperimentPlanner3D_v21):
    def __init__(
        ...
        self.data_identifier = "hypunetData_pretrained_" + pretrained_name
        self.plans_fname = join(
            self.preprocessed_output_folder,
            "hypunetPlans_pretrained_%s_plans_3D.pkl" % pretrained_name,
        )
