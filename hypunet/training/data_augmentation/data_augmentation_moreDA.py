...
from hypunet.training.data_augmentation.custom_transforms import (
...
from hypunet.training.data_augmentation.downsampling import (
    DownsampleSegForDSTransform3,
    DownsampleSegForDSTransform2,
)
from hypunet.training.data_augmentation.pyramid_augmentations import (
...
def get_moreDA_augmentation(
    ...
    if meta:
        tr_transforms.append(NumpyToTensor(["meta"], "float"))
    ...
    if meta:
        val_transforms.append(NumpyToTensor(["meta"], "float"))
