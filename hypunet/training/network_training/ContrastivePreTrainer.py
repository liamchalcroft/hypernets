...
import numpy as np
import torch
from hypunet.training.data_augmentation.data_augmentation_contrastive import (
    get_contrastive_augmentation,
)
from hypunet.utilities.to_torch import maybe_to_torch, to_cuda
from hypunet.network_architecture.generic_UNet import (
...
from hypunet.training.dataloading.dataset_loading import (
    load_dataset,
    DataLoader3D,
    DataLoader2D,
    unpack_dataset,
...
class ContrastivePreTrainer(NetworkPreTrainer):
    ...
    def process_plans(self, plans):
        ...
        if (
            ...
            print(
                "WARNING! You seem to have data that was preprocessed with a previous version of hypunet. "
