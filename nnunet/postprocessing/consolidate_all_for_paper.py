...
from hypunet.utilities.folder_names import get_output_folder_name
...
def get_commands(configurations, regular_trainer="hypunetTrainerV2", cascade_trainer="hypunetTrainerV2CascadeFullRes",
                 plans="hypunetPlansv2.1"):
    ...
    for task in configurations:
        ...
        for m in models:
            ...
            folder = get_output_folder_name(m, task, trainer, plans, overwrite_training_output_dir="/datasets/datasets_fabian/results/hypunet")
