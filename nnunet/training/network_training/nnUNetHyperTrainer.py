...
class nnUNetHyperTrainer(HyperNetworkTrainer):
    ...
    def preprocess_patient(self, input_files):
        ...
        d, m, s, properties = preprocessor.preprocess_test_case(input_files,
    ...
    def preprocess_predict_nifti(self, input_files: List[str], output_file: str = None,
        ...
        """
        print("preprocessing...")
        d, m, s, properties = self.preprocess_patient(input_files)
        print("predicting...")
        pred = self.predict_preprocessed_data_return_seg_and_softmax(d, m, do_mirroring=self.data_aug_params["do_mirror"],
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, meta: np.ndarray, do_mirroring: bool = True,
        ...
        if self.hypernetwork is not None and self.hyper_depth is not None:
            ...
            self.hypernetwork._set_weights(self.network, self.hypernetwork._make_chunks(weights[0]))
        # line above should have updated weights for metadata instance
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        for k in self.dataset_val.keys():
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii.gz"))) or \
                ...
                meta = np.load(self.dataset[k]['data_file'])['meta']
