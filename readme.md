...
The trained models will be written to the hypunet_results_folder/hypunet folder. Each training obtains an automatically generated
output folder name:
...
For Task002_Heart (from the MSD), for example, this looks like this:
    ...
    hypunet_results_folder/hypunet/
    ├── 2d
    │   └── Task02_Heart
...
directory (hypunet_results_folder/hypunet/CONFIGURATION/TaskXXX_MYTASK/TRAINER_CLASS_NAME__PLANS_FILE_IDENTIFIER/postprocessing.json or
hypunet_results_folder/hypunet/ensembles/TaskXXX_MYTASK/ensemble_X__Y__Z--X__Y__Z/postprocessing.json). You can also choose to
